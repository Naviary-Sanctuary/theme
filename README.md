...
Naviary Sanctuary Theme is a calm dark theme for Visual Studio Code, designed around the Naviary brand palette.

It uses low-glare dark surfaces for long coding sessions, with warm orange accents for active states, focus, and important UI signals.

![Naviary Sanctuary Theme screenshot](images/screenshot.png)

## Themes

This extension includes two dark themes:
...
- Comfortable dark backgrounds for extended reading and editing.
...
Choose either **Naviary Pastel Dark** or **Naviary Dark**.
